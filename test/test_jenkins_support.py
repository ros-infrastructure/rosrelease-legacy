...
def test_trigger_source_deb():
    ...
    assert url == 'http://jenkins.willowgarage.com:8080/job/_dry_sourcedeb/buildWithParameters?STACK_NAME=common&STACK_VERSION=1.8.0&token=RELEASE_SOURCE_DEB&DISTRO_NAME=fuerte'
